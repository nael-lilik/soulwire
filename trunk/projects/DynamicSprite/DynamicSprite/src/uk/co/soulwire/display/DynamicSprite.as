...
package uk.co.soulwire.display 
{
	...
	public class DynamicSprite extends Sprite 
	{
		...
		public static const LIBRARY_UPDATED_START : String = "DynamicSprite::libraryUpdatedStart";
		 ...
		 */
				public static const LIBRARY_UPDATED_COMPLETE : String = "DynamicSprite::libraryUpdatedComplete";
		...
		public static function update(libraryID : String, librarySWF : DisplayObject) : void
		{
			...
			dispatchEvent( new Event( LIBRARY_UPDATED_START ));
		}
		...
		public function DynamicSprite(__classDefinition : String = '')
		{
			...
			DynamicSprite.addEventListener(DynamicSprite.LIBRARY_UPDATED_START, update, false, -1, false);
			update();
		}
		...
		public function destroy() : void
		{
			...
			DynamicSprite.removeEventListener(DynamicSprite.LIBRARY_UPDATED_START, update);
			destroyAsset();
		}
		...
		private function update(event : Event = null) : void
		{
			...
			{
				DynamicSprite.dispatchEvent( new Event( DynamicSprite.LIBRARY_UPDATED_COMPLETE ));
			}
		}
