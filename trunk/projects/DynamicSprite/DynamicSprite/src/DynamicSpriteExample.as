...
package  
{
	...
	public class DynamicSpriteExample extends Sprite 
	{
		...
		public function DynamicSpriteExample()
		{
			...
			DynamicSprite.addEventListener(DynamicSprite.LIBRARY_UPDATED_START, onLibraryUpdateStart);
			// ...and for when all instances have been updated from it.			DynamicSprite.addEventListener(DynamicSprite.LIBRARY_UPDATED_COMPLETE, onLibraryUpdateComplete);
